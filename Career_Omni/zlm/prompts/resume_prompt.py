...
def generate_resume(job_description: str) -> str:
    """
    Generate a resume based on the provided job description.
    ...
    try:
        ...
        # This is a placeholder that returns a dummy resume
        return f"""
JOHN DOE
Software Engineer
...
Experienced software engineer with expertise aligned to the following job requirements:
{job_description[:200]}...
